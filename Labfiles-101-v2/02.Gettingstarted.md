...
1. Once the environment is provisioned, a virtual machine and lab guide will be loaded in your browser. To perform the lab, use this virtual machine during the session.

    ![](./Media/158.png)

1. To get the lab environment details, you can select the **Environment Details** tab. Additionally, the credentials will also be emailed to the email address provided at registration.
...
## Task 1: Log in to the Azure Portal and verify the pre-deployed resources.
...
1. Now that you can see the Azure Portal Dashboard, click on **Resource groups** from the Navigate panel to see the resource groups.
